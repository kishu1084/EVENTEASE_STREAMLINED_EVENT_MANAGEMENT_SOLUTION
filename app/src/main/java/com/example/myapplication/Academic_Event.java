...
public class Academic_Event extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView = findViewById(R.id.grideView_academic);
        dataList = new ArrayList<>();

        // Correcting the arguments passed to MyAdapter constructor
        adapter = new MyAdapter(dataList, Academic_Event.this);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final String previousClassName = "Academic";
                DataClass clickedItem = dataList.get(position);
                Context context = Academic_Event.this;
              ...
              intent.putExtra("previousClassName", previousClassName);
                ...
                Toast.makeText(Academic_Event.this, "Clicked: " + clickedItem.getCaption(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        eventsRef.child("Academic Events").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Academic_Event.this, "Failed to retrieve data", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Academic_Event.this, UploadActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void openFragment(Fragment fragment) {
        ...
        transaction.replace(R.id.academic_event_container, fragment);
