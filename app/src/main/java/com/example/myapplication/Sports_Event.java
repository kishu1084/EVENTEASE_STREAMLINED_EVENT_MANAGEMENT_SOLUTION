...
public class Sports_Event extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView = findViewById(R.id.grideView_sport);

        dataList = new ArrayList<>();

        // Correcting the arguments passed to MyAdapter constructor
        adapter = new MyAdapter(dataList, Sports_Event.this);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final String previousClassName = "Sports";
                Context context = Sports_Event.this;
                ...
                Toast.makeText(Sports_Event.this, "Clicked: " + clickedItem.getCaption(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        eventsRef.child("Sports Events").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Sports_Event.this, "Failed to retrieve data", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Sports_Event.this, UploadActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void openFragment(Fragment fragment) {
        ...
        transaction.replace(R.id.sport_event_container, fragment);
