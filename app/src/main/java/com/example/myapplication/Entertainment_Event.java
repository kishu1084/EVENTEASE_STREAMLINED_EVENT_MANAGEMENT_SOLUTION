...
public class Entertainment_Event extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView = findViewById(R.id.grideView_entertainment);

        dataList = new ArrayList<>();

        // Correcting the arguments passed to MyAdapter constructor
        adapter = new MyAdapter(dataList, Entertainment_Event.this);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final String previousClassName = "Entertainment";
                DataClass clickedItem = dataList.get(position);
                Context context = Entertainment_Event.this;
                ...
                Toast.makeText(Entertainment_Event.this, "Clicked: " + clickedItem.getCaption(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        eventsRef.child("Entertainment Events").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Entertainment_Event.this, "Failed to retrieve data", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Entertainment_Event.this, UploadActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void openFragment(Fragment fragment) {
        ...
        transaction.replace(R.id.entertainment_event_container, fragment);
